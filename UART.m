...
%SendDeviation(500e3, coeff, RAMP1,  s); %deviation - kHz (in function 500e3 = 500MHz)
%SendCommand(command, s) %only for STOP_RESET_TEST_RAMP1_RAMP2

period_Number_stm32 = 4;  % max period_Number_stm32_stm32 = 4
period_Number_pc = 1; % can be any number
SIZE_ADC = 128;
ADC_PER_DAC = 4; % amount perios of ADC in 1 period DAC
ADC_FREQ = 576e3;
...
while(true)
    if count < 25000
        ...
        message_size = (size_m - 1)*size_uint32; % in bytes
